...
If the cubes are positive then there is a conjecture that they can be any natural number except 23. So far this program has checked this conjecture for all values of n up to a quarter of a quadrillion and not found any counter examples.
...
| 2024-05-07 19:56  | 2024-0-23 06:44 | 251,055,040,394,046 | Mark Pinsker | i7-6700 CPU@3.40GHz | Python pypy3.10-v7.3.15-win64 | 23Conjecture.py |
